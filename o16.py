...
class Patient:
    ...
    def calculate_lab_test_charge(self):
        ...
        charge = 0
        for each_test in self.__list_of_lab_test_ids:
            charge += LabTestRepository.get_test_charge(each_test)
...
class LabTestRepository:
    ...
    def get_test_charge(lab_test_id):
        ...
        if lab_test_id in LabTestRepository.__list_of_hospital_lab_test_ids:
            for i in (0,len(LabTestRepository.__list_of_hospital_lab_test_ids)):
