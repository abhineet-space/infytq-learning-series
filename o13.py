...
class Util:
    ...
    def parse_customer(self,list_of_customers,list_of_calls):
        for each_customer in list_of_customers:
            temp = []
            for each_call in list_of_calls:
                if each_customer.phone_no == each_call.phone_no:
                    temp.append(each_call)
            each_customer.list_of_calls= temp
            self.list_of_customer_calldetail_objects.append(each_customer)
