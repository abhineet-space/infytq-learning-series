...
class Flower:
    flower_dic={'Orchid':15,'Rose':25,'Jasmine':40}
    def __init__(self):
    ...
    def set_flower_name(self,flower_name):
        self.__flower_name = flower_name.capitalize()
    ...
    def validate_flower(self):
        if self.__flower_name in self.flower_dic:
            return True
        else:
            return False
    ...
    def check_level(self):
        if self.validate_flower() and (self.__stock_available < self.flower_dic[self.__flower_name]):
            return True
        else:
            return False

fl1 = Flower()
fl1.set_flower_name("cacti")
fl1.set_price_per_kg(200)
fl1.set_stock_available(53)

print(fl1.validate_flower())
print(fl1.get_flower_name())