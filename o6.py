...
class Student:
    ...
    def choose_course(self,course_id):
        course_available = {1001:25575.0,1002:15500.0}
        if course_id in course_available:
            self.__course_id = course_id
            if self.__marks > 85:
                self.__fees = course_available[course_id] - ((25/100) * course_available[course_id])
            else:
                self.__fees = course_available[course_id]
            return True
